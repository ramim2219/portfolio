...
import { leadershipData, getLeadershipById } from "@/src/components/leadershipData";
...
const INFO_ICONS = [CalendarDays, BookOpen, Users, Trophy];
...
const LeadershipDetail = ({ role }) => {
  return (
    <>
        ...
        <section className="section project-nav-section">
          <div className="container">
            <div className="project-nav-row">
              ...
              <Link href="/#work" className="project-nav-link next">
                <div>
                  <small>See</small>
                  <span>Portfolio</span>
                </div>
      ...
      {/* Reuse the exact same case-study styles from pages/projects/[id].js */}
      <style jsx>{`
        .back-link {
          display: inline-flex;
          align-items: center;
        ...
        .challenge-row.is-solution .challenge-label { color: #047857; }
